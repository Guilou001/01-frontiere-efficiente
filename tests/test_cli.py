...
def test_cli_demo_writes_tables_and_figures(tmp_path):
    ...
    assert {"frontier_sample.csv", "finquant_check_sample.csv", "oos_inference_inputs.csv", "special_portfolios_sample.csv", "montecarlo_summary_sample.csv", "oos_metrics.csv",
